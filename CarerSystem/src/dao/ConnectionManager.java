...
public class ConnectionManager {
	...
	private static final String url = "jdbc:oracle:thin:@203.233.199.34:1521:xe";	// URL
	private static final String dbid = "userid";	// 데이터베이스 ID
	private static final String dbpw = "userpassword";	// 데이터베이스 비밀번호
